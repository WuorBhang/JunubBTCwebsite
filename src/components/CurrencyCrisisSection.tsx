        ...
        <section className="bg-[#F7F7F7] px-6 py-24 border-t border-black/10">
            <div className="max-w-[88rem] mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    <div className="lg:col-span-2 bg-black rounded-2xl p-10 min-h-[420px] flex flex-col">
                        <div className="flex items-center gap-2 text-[#F5F5F5]/60 text-sm mb-8">
                            ...
                            <div className="w-full grid grid-cols-2 gap-8 items-end">
                                ...
                                <div className="flex flex-col items-start">
                                    <div className="flex items-baseline gap-2 mb-3">
                                        <span
                                            className="text-3xl md:text-4xl font-medium text-[#F5F5F5]"
                                            style={{ letterSpacing: '-0.03em' }}
                                        >
                                            150
                                        </span>
                                        <span className="text-[#F5F5F5]/60 text-sm">SSP</span>
                                    </div>
                                    <div
                                        className="w-full bg-[#F7931A]/40 rounded-xl"
                                        style={{ height: '12px' }}
                                    />
                                    <p className="mt-3 text-[#F5F5F5]/60 text-sm">
                                ...
                                <div className="flex flex-col items-start">
                                    ...
                                    <div
                                        className="w-full bg-[#F7931A] rounded-xl"
                                        style={{ height: '220px' }}
                                    />
                                    <p className="mt-3 text-[#F5F5F5]/60 text-sm">
                    ...
                    <div className="bg-[#F7931A] rounded-2xl p-10 min-h-[420px] flex flex-col justify-between">
                        <div>
                            <div className="flex items-center gap-2 text-[#F5F5F5]/80 text-sm mb-6">
                                <Shield className="w-4 h-4" />
                                The hedge
                            </div>
                            <p
                                className="text-[#F5F5F5] text-3xl md:text-4xl font-medium leading-tight"
