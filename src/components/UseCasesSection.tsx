            ...
            <div className="max-w-[88rem] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                ...
                <div className="relative rounded-3xl overflow-hidden min-h-[720px]">
                    ...
                    <div className="relative z-10 p-10 md:p-12">
                        <h3
                            className="text-[#F5F5F5] text-4xl md:text-5xl font-medium leading-tight mb-5 drop-shadow-lg"
                            style={{ letterSpacing: '-0.03em' }}
                        >
                            Commerce
                        </h3>
                        <p className="text-[#F5F5F5]/90 text-base max-w-md mb-8 drop-shadow">
                        ...
                        <a
                            href="/momo"
                            className="inline-flex items-center gap-3 bg-black text-[#F5F5F5] font-medium pl-2 pr-6 py-2 rounded-full hover:bg-black/80 transition-colors duration-200"
                        >
                            <span className="w-9 h-9 rounded-full bg-[#F7931A] flex items-center justify-center">
